...
class GenericSolver {
  public:
    ...
    inline gtsam::Values calculateBestEstimate() const
    {
        return values_;
    }
    inline gtsam::Values getLinearizationPoint() const
    {
        return values_;
    }
    inline gtsam::NonlinearFactorGraph getFactorsUnsafe() const
    {
        return nfg_;
    }
