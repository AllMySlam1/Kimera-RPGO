...
TEST(RobustSolver, LandmarkPcm)
{
    ...
    landmark_factors.add(gtsam::BetweenFactor<gtsam::Pose3>(
        a1, l0, gtsam::Pose3(gtsam::Rot3(), gtsam::Point3(0, 1, 0)),
        lmk_noise));
    ...
    landmark_factors.add(gtsam::BetweenFactor<gtsam::Pose3>(
        a5, l0, gtsam::Pose3(gtsam::Rot3(), gtsam::Point3(0, -1, 0)),
        lmk_noise));
    pgo->update(landmark_factors, landmark_values);
    ...
    landmark_values  = gtsam::Values();
    landmark_factors.add(gtsam::BetweenFactor<gtsam::Pose3>(
        a4, l0, gtsam::Pose3(gtsam::Rot3(), gtsam::Point3(1, 0, 0)),
        lmk_noise));
    pgo->update(landmark_factors, landmark_values);
    ...
    landmark_factors.add(gtsam::BetweenFactor<gtsam::Pose3>(
        a2, l1, gtsam::Pose3(gtsam::Rot3(), gtsam::Point3(0, -1, 0)),
        lmk_noise));
    ...
    landmark_values  = gtsam::Values();
    landmark_factors.add(gtsam::BetweenFactor<gtsam::Pose3>(
        a5, l1, gtsam::Pose3(gtsam::Rot3(), gtsam::Point3(2, 0, 0)),
        lmk_noise));
    pgo->update(landmark_factors, landmark_values);
...
TEST(RobustSolver, LandmarkNoReject)
{
    ...
    landmark_values  = gtsam::Values();
    landmark_factors.add(gtsam::BetweenFactor<gtsam::Pose3>(
        a4, l0, gtsam::Pose3(gtsam::Rot3(), gtsam::Point3(2, 0, 0)),
        lmk_noise));
    pgo->update(landmark_factors, landmark_values);
    ...
    landmark_values  = gtsam::Values();
    landmark_factors.add(gtsam::BetweenFactor<gtsam::Pose3>(
        a5, l1, gtsam::Pose3(gtsam::Rot3(R), gtsam::Point3(2, 0, 0)),
        lmk_noise));
    pgo->update(landmark_factors, landmark_values);
