...
TEST(RobustSolver, RemovePriorNoOR)
{
    ...
    // Add prior factors
    factors.add(gtsam::PriorFactor<gtsam::Pose3>(gtsam::Symbol('a', 0),
                                                 gtsam::Pose3(), noise));
    factors.add(gtsam::PriorFactor<gtsam::Pose3>(gtsam::Symbol('a', 1),
                                                 gtsam::Pose3(), noise));
    factors.add(gtsam::PriorFactor<gtsam::Pose3>(gtsam::Symbol('b', 0),
                                                 gtsam::Pose3(), noise));
